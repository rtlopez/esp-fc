...
#elif defined(ESP32)
  #define SDA_LOW()   (GPIO.enable_w1ts = (1 << twi_sda)) //Enable SDA (becomes output and since GPO is 0 for the pin, it will pull the line low)
  #define SDA_HIGH()  (GPIO.enable_w1tc = (1 << twi_sda)) //Disable SDA (becomes input and since it has pullup it will go high)
  #define SDA_READ()  ((GPIO.in & (1 << twi_sda)) != 0)
  #define SCL_LOW()   (GPIO.enable_w1ts = (1 << twi_scl))
  #define SCL_HIGH()  (GPIO.enable_w1tc = (1 << twi_scl))
  #define SCL_READ()  ((GPIO.in & (1 << twi_scl)) != 0)
#else
...
#elif F_CPU == FCPU240
  if(freq <= 100000) twi_dcount = 75;//about 100KHz
  else if(freq <= 200000) twi_dcount = 35;//about 200KHz
  else if(freq <= 300000) twi_dcount = 21;//about 300KHz
  else if(freq <= 400000) twi_dcount = 15;//about 400KHz
  else if(freq <= 500000) twi_dcount = 10;//about 500KHz
  else if(freq <= 600000) twi_dcount = 8;//about 600KHz
  else if(freq <= 800000) twi_dcount = 4;//about 800KHz
