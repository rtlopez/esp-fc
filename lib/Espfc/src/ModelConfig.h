...
#ifndef ESPFC_INPUT_PWM_0_PIN
#define ESPFC_INPUT_PWM_0_PIN -1
#endif

#ifndef ESPFC_INPUT_PWM_1_PIN
#define ESPFC_INPUT_PWM_1_PIN -1
#endif

#ifndef ESPFC_INPUT_PWM_2_PIN
#define ESPFC_INPUT_PWM_2_PIN -1
#endif

#ifndef ESPFC_INPUT_PWM_3_PIN
#define ESPFC_INPUT_PWM_3_PIN -1
#endif

#ifndef ESPFC_INPUT_PWM_4_PIN
#define ESPFC_INPUT_PWM_4_PIN -1
#endif

#ifndef ESPFC_INPUT_PWM_5_PIN
#define ESPFC_INPUT_PWM_5_PIN -1
#endif
...
{
  FEATURE_RX_PPM = 1 << 0,
  FEATURE_RX_PWM = 1 << 13, // Betaflight-compatible PWM RX feature
...
{
#ifdef ESPFC_INPUT
  PIN_INPUT_RX, // PPM input
  // One GPIO per channel.
  // -1 means unused / not mapped.
  PIN_INPUT_PWM_0,
  PIN_INPUT_PWM_1,
  PIN_INPUT_PWM_2,
  PIN_INPUT_PWM_3,
...
int8_t pin[PIN_COUNT] = {
      ...
      // Parallel PWM receiver input pins.
      // Default to unmapped for safety. User configures these through CLI.
      [PIN_INPUT_PWM_0] = -1,
      [PIN_INPUT_PWM_1] = -1,
      [PIN_INPUT_PWM_2] = -1,
      [PIN_INPUT_PWM_3] = -1,
