...
void Cli::Param::print(Stream& stream) const
{
  ...
  switch (type)
  {
    case PARAM_NONE: stream.print(F("NONE")); break;
    case PARAM_BOOL: stream.print(*addr != 0); break;
    case PARAM_BYTE: print(stream, *reinterpret_cast<int8_t*>(addr)); break;
    case PARAM_BYTE_U: print(stream, *reinterpret_cast<uint8_t*>(addr)); break;
    case PARAM_SHORT: print(stream, *reinterpret_cast<int16_t*>(addr)); break;
    case PARAM_INT: print(stream, *reinterpret_cast<int32_t*>(addr)); break;
    case PARAM_FLOAT: stream.print(*reinterpret_cast<float*>(addr), 4); break;
    case PARAM_STRING: stream.print(addr); break;
    case PARAM_BITMASK: stream.print((*reinterpret_cast<int32_t*>(addr) & (1ul << maxLen)) ? 1 : 0); break;
    case PARAM_INPUT_CHANNEL: print(stream, *reinterpret_cast<InputChannelConfig*>(addr)); break;
    case PARAM_OUTPUT_CHANNEL: print(stream, *reinterpret_cast<OutputChannelConfig*>(addr)); break;
    case PARAM_SCALER: print(stream, *reinterpret_cast<ScalerConfig*>(addr)); break;
    case PARAM_MODE: print(stream, *reinterpret_cast<ActuatorCondition*>(addr)); break;
    case PARAM_MIXER: print(stream, *reinterpret_cast<MixerEntry*>(addr)); break;
    case PARAM_SERIAL: print(stream, *reinterpret_cast<SerialPortConfig*>(addr)); break;
  }
}
...
void Cli::Param::update(const char** args) const
{
  ...
  switch (type)
  {
    ...
    case PARAM_FLOAT:
      ...
      break;
    case PARAM_STRING: write(String(v ? v : "")); break;
    case PARAM_BITMASK:
      if (!v) return;
      if (*v == '0')
      {
...
const Cli::Param* Cli::initialize(ModelConfig& c)
{
  ...
  static const char* gyroDlpfChoices[] = {PSTR("256Hz"), PSTR("188Hz"),        PSTR("98Hz"),
                                          PSTR("42Hz"),  PSTR("20Hz"),         PSTR("10Hz"),
                                          PSTR("5Hz"),   PSTR("EXPERIMENTAL"), NULL};
  static const char* debugModeChoices[] = {PSTR("NONE"),
                                           PSTR("CYCLETIME"),
                                           PSTR("BATTERY"),
                                           PSTR("GYRO_FILTERED"),
                                           PSTR("ACCELEROMETER"),
                                           ...
                                           PSTR("DUAL_GYRO_DIFF"),
                                           PSTR("MAX7456_SIGNAL"),
                                           PSTR("MAX7456_SPICLOCK"),
                                           PSTR("SBUS"),
                                           PSTR("FPORT"),
                                           PSTR("RANGEFINDER"),
                                           PSTR("RANGEFINDER_QUALITY"),
                                           PSTR("LIDAR_TF"),
                                           PSTR("ADC_INTERNAL"),
                                           PSTR("RUNAWAY_TAKEOFF"),
                                           PSTR("SDIO"),
                                           PSTR("CURRENT_SENSOR"),
                                           PSTR("USB"),
                                           PSTR("SMARTAUDIO"),
                                           ...
                                           PSTR("RC_SMOOTHING"),
                                           PSTR("RX_SIGNAL_LOSS"),
                                           PSTR("RC_SMOOTHING_RATE"),
                                           PSTR("ANTI_GRAVITY"),
                                           PSTR("DYN_LPF"),
                                           PSTR("RX_SPEKTRUM_SPI"),
                                           PSTR("DSHOT_RPM_TELEMETRY"),
                                           PSTR("RPM_FILTER"),
                                           PSTR("D_MIN"),
                                           PSTR("AC_CORRECTION"),
                                           PSTR("AC_ERROR"),
                                           PSTR("DUAL_GYRO_SCALED"),
                                           PSTR("DSHOT_RPM_ERRORS"),
                                           PSTR("CRSF_LINK_STATISTICS_UPLINK"),
                                           PSTR("CRSF_LINK_STATISTICS_PWR"),
                                           PSTR("CRSF_LINK_STATISTICS_DOWN"),
                                           PSTR("BARO"),
                                           PSTR("GPS_RESCUE_THROTTLE_PID"),
                                           PSTR("DYN_IDLE"),
                                           PSTR("FF_LIMIT"),
                                           PSTR("FF_INTERPOLATED"),
                                           PSTR("BLACKBOX_OUTPUT"),
                                           PSTR("GYRO_SAMPLE"),
                                           PSTR("RX_TIMING"),
                                           NULL};
  static const char* filterTypeChoices[] = {PSTR("PT1"),   PSTR("BIQUAD"),    PSTR("PT2"),  PSTR("PT3"),
                                            PSTR("NOTCH"), PSTR("NOTCH_DF1"), PSTR("BPF"),  PSTR("FO"),
                                            PSTR("FIR2"),  PSTR("MEDIAN3"),   PSTR("NONE"), NULL};
  static const char* alignChoices[] = {
      PSTR("DEFAULT"),   PSTR("CW0"),        PSTR("CW90"),       PSTR("CW180"),  PSTR("CW270"), PSTR("CW0_FLIP"),
      PSTR("CW90_FLIP"), PSTR("CW180_FLIP"), PSTR("CW270_FLIP"), PSTR("CUSTOM"), NULL};
  static const char* mixerTypeChoices[] = {PSTR("NONE"),
                                           PSTR("TRI"),
                                           PSTR("QUADP"),
                                           PSTR("QUADX"),
                                           PSTR("BI"),
  ...
  static const char* inputRateTypeChoices[] = {PSTR("BETAFLIGHT"), PSTR("RACEFLIGHT"), PSTR("KISS"),
                                               PSTR("ACTUAL"),     PSTR("QUICK"),      NULL};
  ...
  static const char* inputItermRelaxChoices[] = {PSTR("OFF"),    PSTR("RP"),      PSTR("RPY"),
                                                 PSTR("RP_INC"), PSTR("RPY_INC"), NULL};
  ...
  static const Param params[] = {
      ...
      Param(PSTR("feature_gps"), &c.featureMask, 7), Param(PSTR("feature_dyn_notch"), &c.featureMask, 29),
      Param(PSTR("feature_motor_stop"), &c.featureMask, 4), Param(PSTR("feature_rx_ppm"), &c.featureMask, 0),
      Param(PSTR("feature_rx_pwm"), &c.featureMask, 13), Param(PSTR("feature_rx_serial"), &c.featureMask, 3),
      Param(PSTR("feature_rx_spi"), &c.featureMask, 25), Param(PSTR("feature_soft_serial"), &c.featureMask, 6),
      Param(PSTR("feature_telemetry"), &c.featureMask, 10),

      Param(PSTR("debug_mode"), &c.debug.mode, debugModeChoices), Param(PSTR("debug_axis"), &c.debug.axis),

      Param(PSTR("gyro_bus"), &c.gyro.bus, busDevChoices), Param(PSTR("gyro_dev"), &c.gyro.dev, gyroDevChoices),
      Param(PSTR("gyro_dlpf"), &c.gyro.dlpf, gyroDlpfChoices), Param(PSTR("gyro_align"), &c.gyro.align, alignChoices),
      ...
      Param(PSTR("gyro_lpf3_freq"), &c.gyro.filter3.freq), Param(PSTR("gyro_notch1_freq"), &c.gyro.notch1Filter.freq),
      ...
      Param(PSTR("gyro_rpm_harmonics"), &c.gyro.rpmFilter.harmonics), Param(PSTR("gyro_rpm_q"), &c.gyro.rpmFilter.q),
      Param(PSTR("gyro_rpm_min_freq"), &c.gyro.rpmFilter.minFreq), Param(PSTR("gyro_rpm_fade"), &c.gyro.rpmFilter.fade),
      ...
      Param(PSTR("gyro_rpm_tlm_lpf_freq"), &c.gyro.rpmFilter.freqLpf), Param(PSTR("gyro_offset_x"), &c.gyro.bias[0]),
      Param(PSTR("gyro_offset_y"), &c.gyro.bias[1]), Param(PSTR("gyro_offset_z"), &c.gyro.bias[2]),

      Param(PSTR("accel_bus"), &c.accel.bus, busDevChoices), Param(PSTR("accel_dev"), &c.accel.dev, gyroDevChoices),
      Param(PSTR("accel_lpf_type"), &c.accel.filter.type, filterTypeChoices),
      Param(PSTR("accel_lpf_freq"), &c.accel.filter.freq), Param(PSTR("accel_offset_x"), &c.accel.bias[0]),
      Param(PSTR("accel_offset_y"), &c.accel.bias[1]), Param(PSTR("accel_offset_z"), &c.accel.bias[2]),

      Param(PSTR("mag_bus"), &c.mag.bus, busDevChoices), Param(PSTR("mag_dev"), &c.mag.dev, magDevChoices),
      Param(PSTR("mag_align"), &c.mag.align, alignChoices),
      Param(PSTR("mag_filter_type"), &c.mag.filter.type, filterTypeChoices),
      Param(PSTR("mag_filter_lpf"), &c.mag.filter.freq), Param(PSTR("mag_offset_x"), &c.mag.offset[0]),
      Param(PSTR("mag_offset_y"), &c.mag.offset[1]), Param(PSTR("mag_offset_z"), &c.mag.offset[2]),
      Param(PSTR("mag_scale_x"), &c.mag.scale[0]), Param(PSTR("mag_scale_y"), &c.mag.scale[1]),
      Param(PSTR("mag_scale_z"), &c.mag.scale[2]),

      Param(PSTR("baro_bus"), &c.baro.bus, busDevChoices), Param(PSTR("baro_dev"), &c.baro.dev, baroDevChoices),
      Param(PSTR("baro_lpf_type"), &c.baro.filter.type, filterTypeChoices),
      Param(PSTR("baro_lpf_freq"), &c.baro.filter.freq),

      Param(PSTR("gps_min_sats"), &c.gps.minSats), Param(PSTR("gps_set_home_once"), &c.gps.setHomeOnce),

      Param(PSTR("gps_gnss_mode"), &c.gps.gnssMode), Param(PSTR("gps_enable_dual_band"), &c.gps.enableDualBand),
      Param(PSTR("gps_enable_gps"), &c.gps.enableGPS), Param(PSTR("gps_enable_glonass"), &c.gps.enableGLONASS),
      Param(PSTR("gps_enable_galileo"), &c.gps.enableGalileo), Param(PSTR("gps_enable_beidou"), &c.gps.enableBeiDou),
      Param(PSTR("gps_enable_qzss"), &c.gps.enableQZSS), Param(PSTR("gps_enable_sbas"), &c.gps.enableSBAS),

      Param(PSTR("board_align_roll"), &c.boardAlignment[0]), Param(PSTR("board_align_pitch"), &c.boardAlignment[1]),
      Param(PSTR("board_align_yaw"), &c.boardAlignment[2]),

      Param(PSTR("vbat_source"), &c.vbat.source, voltageSourceChoices), Param(PSTR("vbat_scale"), &c.vbat.scale),
      Param(PSTR("vbat_mul"), &c.vbat.resMult), Param(PSTR("vbat_div"), &c.vbat.resDiv),
      Param(PSTR("vbat_cell_warn"), &c.vbat.cellWarning),

      Param(PSTR("ibat_source"), &c.ibat.source, currentSourceChoices), Param(PSTR("ibat_scale"), &c.ibat.scale),
      Param(PSTR("ibat_offset"), &c.ibat.offset),

      Param(PSTR("fusion_mode"), &c.fusion.mode, fusionModeChoices), Param(PSTR("fusion_gain_p"), &c.fusion.gain),
      Param(PSTR("fusion_gain_i"), &c.fusion.gainI),

      Param(PSTR("input_rate_type"), &c.input.rateType, inputRateTypeChoices),

      Param(PSTR("input_roll_rate"), &c.input.rate[0]), Param(PSTR("input_roll_srate"), &c.input.superRate[0]),
      Param(PSTR("input_roll_expo"), &c.input.expo[0]), Param(PSTR("input_roll_limit"), &c.input.rateLimit[0]),

      Param(PSTR("input_pitch_rate"), &c.input.rate[1]), Param(PSTR("input_pitch_srate"), &c.input.superRate[1]),
      Param(PSTR("input_pitch_expo"), &c.input.expo[1]), Param(PSTR("input_pitch_limit"), &c.input.rateLimit[1]),

      Param(PSTR("input_yaw_rate"), &c.input.rate[2]), Param(PSTR("input_yaw_srate"), &c.input.superRate[2]),
      Param(PSTR("input_yaw_expo"), &c.input.expo[2]), Param(PSTR("input_yaw_limit"), &c.input.rateLimit[2]),

      Param(PSTR("input_deadband"), &c.input.deadband),

      Param(PSTR("input_min"), &c.input.minRc), Param(PSTR("input_mid"), &c.input.midRc),
      ...
      Param(PSTR("input_lpf_freq"), &c.input.filter.freq), Param(PSTR("input_lpf_factor"), &c.input.filterAutoFactor),
      ...
      Param(PSTR("input_0"), &c.input.channel[0]), Param(PSTR("input_1"), &c.input.channel[1]),
      Param(PSTR("input_2"), &c.input.channel[2]), Param(PSTR("input_3"), &c.input.channel[3]),
      Param(PSTR("input_4"), &c.input.channel[4]), Param(PSTR("input_5"), &c.input.channel[5]),
      Param(PSTR("input_6"), &c.input.channel[6]), Param(PSTR("input_7"), &c.input.channel[7]),
      Param(PSTR("input_8"), &c.input.channel[8]), Param(PSTR("input_9"), &c.input.channel[9]),
      Param(PSTR("input_10"), &c.input.channel[10]), Param(PSTR("input_11"), &c.input.channel[11]),
      Param(PSTR("input_12"), &c.input.channel[12]), Param(PSTR("input_13"), &c.input.channel[13]),
      Param(PSTR("input_14"), &c.input.channel[14]), Param(PSTR("input_15"), &c.input.channel[15]),

      Param(PSTR("failsafe_delay"), &c.failsafe.delay), Param(PSTR("failsafe_kill_switch"), &c.failsafe.killSwitch),

      Param(PSTR("vtx_power"), &c.vtx.power), Param(PSTR("vtx_channel"), &c.vtx.channel),
      Param(PSTR("vtx_band"), &c.vtx.band), Param(PSTR("vtx_low_power_disarm"), &c.vtx.lowPowerDisarm),
      ...
      Param(PSTR("scaler_0"), &c.scaler[0]), Param(PSTR("scaler_1"), &c.scaler[1]),
      Param(PSTR("scaler_2"), &c.scaler[2]),

      Param(PSTR("mode_0"), &c.conditions[0]), Param(PSTR("mode_1"), &c.conditions[1]),
      Param(PSTR("mode_2"), &c.conditions[2]), Param(PSTR("mode_3"), &c.conditions[3]),
      Param(PSTR("mode_4"), &c.conditions[4]), Param(PSTR("mode_5"), &c.conditions[5]),
      Param(PSTR("mode_6"), &c.conditions[6]), Param(PSTR("mode_7"), &c.conditions[7]),

      Param(PSTR("pid_sync"), &c.loopSync),

      Param(PSTR("pid_roll_p"), &c.pid[FC_PID_ROLL].P), Param(PSTR("pid_roll_i"), &c.pid[FC_PID_ROLL].I),
      Param(PSTR("pid_roll_d"), &c.pid[FC_PID_ROLL].D), Param(PSTR("pid_roll_f"), &c.pid[FC_PID_ROLL].F),

      Param(PSTR("pid_pitch_p"), &c.pid[FC_PID_PITCH].P), Param(PSTR("pid_pitch_i"), &c.pid[FC_PID_PITCH].I),
      Param(PSTR("pid_pitch_d"), &c.pid[FC_PID_PITCH].D), Param(PSTR("pid_pitch_f"), &c.pid[FC_PID_PITCH].F),

      Param(PSTR("pid_yaw_p"), &c.pid[FC_PID_YAW].P), Param(PSTR("pid_yaw_i"), &c.pid[FC_PID_YAW].I),
      Param(PSTR("pid_yaw_d"), &c.pid[FC_PID_YAW].D), Param(PSTR("pid_yaw_f"), &c.pid[FC_PID_YAW].F),

      Param(PSTR("pid_level_p"), &c.pid[FC_PID_LEVEL].P), Param(PSTR("pid_level_i"), &c.pid[FC_PID_LEVEL].I),
      Param(PSTR("pid_level_d"), &c.pid[FC_PID_LEVEL].D), Param(PSTR("pid_level_f"), &c.pid[FC_PID_LEVEL].F),
      ...
      Param(PSTR("pid_althold_vel_p"), &c.pid[FC_PID_VEL].P), Param(PSTR("pid_althold_vel_i"), &c.pid[FC_PID_VEL].I),
      Param(PSTR("pid_althold_vel_d"), &c.pid[FC_PID_VEL].D), Param(PSTR("pid_althold_vel_f"), &c.pid[FC_PID_VEL].F),
      ...
      Param(PSTR("pid_dterm_weight"), &c.dterm.setpointWeight), Param(PSTR("pid_iterm_limit"), &c.iterm.limit),
      Param(PSTR("pid_iterm_zero"), &c.iterm.lowThrottleZeroIterm),
      Param(PSTR("pid_iterm_relax"), &c.iterm.relax, inputItermRelaxChoices),
      Param(PSTR("pid_iterm_relax_cutoff"), &c.iterm.relaxCutoff), Param(PSTR("pid_tpa_scale"), &c.controller.tpaScale),
      Param(PSTR("pid_tpa_breakpoint"), &c.controller.tpaBreakpoint),

      Param(PSTR("mixer_sync"), &c.mixerSync), Param(PSTR("mixer_type"), &c.mixer.type, mixerTypeChoices),
      ...
      Param(PSTR("output_motor_async"), &c.output.async), Param(PSTR("output_motor_rate"), &c.output.rate),
      ...
      Param(PSTR("output_max_throttle"), &c.output.maxThrottle), Param(PSTR("output_dshot_idle"), &c.output.dshotIdle),
#ifdef ESPFC_DSHOT_TELEMETRY
      Param(PSTR("output_dshot_telemetry"), &c.output.dshotTelemetry),
#endif
      Param(PSTR("output_0"), &c.output.channel[0]), Param(PSTR("output_1"), &c.output.channel[1]),
      Param(PSTR("output_2"), &c.output.channel[2]), Param(PSTR("output_3"), &c.output.channel[3]),
...
#endif
#ifdef ESPFC_INPUT
      Param(PSTR("pin_input_rx"), &c.pin[PIN_INPUT_RX]), Param(PSTR("pin_input_pwm_0"), &c.pin[PIN_INPUT_PWM_0]),
      Param(PSTR("pin_input_pwm_1"), &c.pin[PIN_INPUT_PWM_1]), Param(PSTR("pin_input_pwm_2"), &c.pin[PIN_INPUT_PWM_2]),
      Param(PSTR("pin_input_pwm_3"), &c.pin[PIN_INPUT_PWM_3]), Param(PSTR("pin_input_pwm_4"), &c.pin[PIN_INPUT_PWM_4]),
      Param(PSTR("pin_input_pwm_5"), &c.pin[PIN_INPUT_PWM_5]), Param(PSTR("pin_input_pwm_6"), &c.pin[PIN_INPUT_PWM_6]),
      Param(PSTR("pin_input_pwm_7"), &c.pin[PIN_INPUT_PWM_7]),
#endif
      Param(PSTR("pin_output_0"), &c.pin[PIN_OUTPUT_0]), Param(PSTR("pin_output_1"), &c.pin[PIN_OUTPUT_1]),
      Param(PSTR("pin_output_2"), &c.pin[PIN_OUTPUT_2]), Param(PSTR("pin_output_3"), &c.pin[PIN_OUTPUT_3]),
#if ESPFC_OUTPUT_COUNT > 4
...
#endif
      Param(PSTR("pin_button"), &c.pin[PIN_BUTTON]), Param(PSTR("pin_buzzer"), &c.pin[PIN_BUZZER]),
      Param(PSTR("pin_led"), &c.pin[PIN_LED_BLINK]),
#if defined(ESPFC_SERIAL_0) && defined(ESPFC_SERIAL_REMAP_PINS)
      Param(PSTR("pin_serial_0_tx"), &c.pin[PIN_SERIAL_0_TX]), Param(PSTR("pin_serial_0_rx"), &c.pin[PIN_SERIAL_0_RX]),
#endif
#if defined(ESPFC_SERIAL_1) && defined(ESPFC_SERIAL_REMAP_PINS)
      Param(PSTR("pin_serial_1_tx"), &c.pin[PIN_SERIAL_1_TX]), Param(PSTR("pin_serial_1_rx"), &c.pin[PIN_SERIAL_1_RX]),
#endif
#if defined(ESPFC_SERIAL_2) && defined(ESPFC_SERIAL_REMAP_PINS)
      Param(PSTR("pin_serial_2_tx"), &c.pin[PIN_SERIAL_2_TX]), Param(PSTR("pin_serial_2_rx"), &c.pin[PIN_SERIAL_2_RX]),
#endif
#ifdef ESPFC_I2C_0
      Param(PSTR("pin_i2c_scl"), &c.pin[PIN_I2C_0_SCL]), Param(PSTR("pin_i2c_sda"), &c.pin[PIN_I2C_0_SDA]),
#endif
#ifdef ESPFC_ADC_0
...
#endif
#ifdef ESPFC_SPI_0
      Param(PSTR("pin_spi_0_sck"), &c.pin[PIN_SPI_0_SCK]), Param(PSTR("pin_spi_0_mosi"), &c.pin[PIN_SPI_0_MOSI]),
      Param(PSTR("pin_spi_0_miso"), &c.pin[PIN_SPI_0_MISO]), Param(PSTR("pin_spi_cs_0"), &c.pin[PIN_SPI_CS0]),
      Param(PSTR("pin_spi_cs_1"), &c.pin[PIN_SPI_CS1]), Param(PSTR("pin_spi_cs_2"), &c.pin[PIN_SPI_CS2]),
#endif
      Param(PSTR("pin_buzzer_invert"), &c.buzzer.inverted), Param(PSTR("pin_led_invert"), &c.led.invert),
      ...
      Param(PSTR("mix_outputs"), &c.customMixerCount), Param(PSTR("mix_0"), &c.customMixes[i++]),
      Param(PSTR("mix_1"), &c.customMixes[i++]), Param(PSTR("mix_2"), &c.customMixes[i++]),
      Param(PSTR("mix_3"), &c.customMixes[i++]), Param(PSTR("mix_4"), &c.customMixes[i++]),
      Param(PSTR("mix_5"), &c.customMixes[i++]), Param(PSTR("mix_6"), &c.customMixes[i++]),
      Param(PSTR("mix_7"), &c.customMixes[i++]), Param(PSTR("mix_8"), &c.customMixes[i++]),
      Param(PSTR("mix_9"), &c.customMixes[i++]), Param(PSTR("mix_10"), &c.customMixes[i++]),
      Param(PSTR("mix_11"), &c.customMixes[i++]), Param(PSTR("mix_12"), &c.customMixes[i++]),
      Param(PSTR("mix_13"), &c.customMixes[i++]), Param(PSTR("mix_14"), &c.customMixes[i++]),
      Param(PSTR("mix_15"), &c.customMixes[i++]), Param(PSTR("mix_16"), &c.customMixes[i++]),
      Param(PSTR("mix_17"), &c.customMixes[i++]), Param(PSTR("mix_18"), &c.customMixes[i++]),
      Param(PSTR("mix_19"), &c.customMixes[i++]), Param(PSTR("mix_20"), &c.customMixes[i++]),
      Param(PSTR("mix_21"), &c.customMixes[i++]), Param(PSTR("mix_22"), &c.customMixes[i++]),
      Param(PSTR("mix_23"), &c.customMixes[i++]), Param(PSTR("mix_24"), &c.customMixes[i++]),
      Param(PSTR("mix_25"), &c.customMixes[i++]), Param(PSTR("mix_26"), &c.customMixes[i++]),
      Param(PSTR("mix_27"), &c.customMixes[i++]), Param(PSTR("mix_28"), &c.customMixes[i++]),
      Param(PSTR("mix_29"), &c.customMixes[i++]), Param(PSTR("mix_30"), &c.customMixes[i++]),
      Param(PSTR("mix_31"), &c.customMixes[i++]), Param(PSTR("mix_32"), &c.customMixes[i++]),
      Param(PSTR("mix_33"), &c.customMixes[i++]), Param(PSTR("mix_34"), &c.customMixes[i++]),
      Param(PSTR("mix_35"), &c.customMixes[i++]), Param(PSTR("mix_36"), &c.customMixes[i++]),
      Param(PSTR("mix_37"), &c.customMixes[i++]), Param(PSTR("mix_38"), &c.customMixes[i++]),
      Param(PSTR("mix_39"), &c.customMixes[i++]), Param(PSTR("mix_40"), &c.customMixes[i++]),
      Param(PSTR("mix_41"), &c.customMixes[i++]), Param(PSTR("mix_42"), &c.customMixes[i++]),
      Param(PSTR("mix_43"), &c.customMixes[i++]), Param(PSTR("mix_44"), &c.customMixes[i++]),
      Param(PSTR("mix_45"), &c.customMixes[i++]), Param(PSTR("mix_46"), &c.customMixes[i++]),
      Param(PSTR("mix_47"), &c.customMixes[i++]), Param(PSTR("mix_48"), &c.customMixes[i++]),
      Param(PSTR("mix_49"), &c.customMixes[i++]), Param(PSTR("mix_50"), &c.customMixes[i++]),
      Param(PSTR("mix_51"), &c.customMixes[i++]), Param(PSTR("mix_52"), &c.customMixes[i++]),
      Param(PSTR("mix_53"), &c.customMixes[i++]), Param(PSTR("mix_54"), &c.customMixes[i++]),
      Param(PSTR("mix_55"), &c.customMixes[i++]), Param(PSTR("mix_56"), &c.customMixes[i++]),
      Param(PSTR("mix_57"), &c.customMixes[i++]), Param(PSTR("mix_58"), &c.customMixes[i++]),
      Param(PSTR("mix_59"), &c.customMixes[i++]), Param(PSTR("mix_60"), &c.customMixes[i++]),
      Param(PSTR("mix_61"), &c.customMixes[i++]), Param(PSTR("mix_62"), &c.customMixes[i++]),
...
void Cli::execute(CliCmd& cmd, Stream& s)
{
  ...
  {
    static const char* const helps[] = {PSTR("available commands:"), PSTR(" help"), PSTR(" dump"), PSTR(" get param"),
                                        PSTR(" set param value ..."), PSTR(" cal [gyro]"), PSTR(" defaults"),
                                        PSTR(" save"), PSTR(" reboot"), PSTR(" scaler"), PSTR(" mixer"), PSTR(" stats"),
                                        PSTR(" status"), PSTR(" devinfo"), PSTR(" version"), PSTR(" logs"),
                                        PSTR(" gps [set_home|clear_home]"),
  ...
  else if (strcmp_P(cmd.args[0], PSTR("status")) == 0)
  {
    ...
    static const char* armingDisableNames[] = {PSTR("NO_GYRO"),
                                               PSTR("FAILSAFE"),
                                               PSTR("RX_FAILSAFE"),
                                               PSTR("BAD_RX_RECOVERY"),
                                               PSTR("BOXFAILSAFE"),
                                               PSTR("RUNAWAY_TAKEOFF"),
                                               PSTR("CRASH_DETECTED"),
                                               PSTR("THROTTLE"),
                                               PSTR("ANGLE"),
                                               PSTR("BOOT_GRACE_TIME"),
                                               PSTR("NOPREARM"),
                                               PSTR("LOAD"),
                                               PSTR("CALIBRATING"),
                                               PSTR("CLI"),
                                               ...
                                               PSTR("RESC"),
                                               PSTR("RPMFILTER"),
                                               PSTR("REBOOT_REQUIRED"),
                                               PSTR("DSHOT_BITBANG"),
                                               PSTR("ACC_CALIBRATION"),
                                               PSTR("MOTOR_PROTOCOL"),
                                               PSTR("ARM_SWITCH")};
