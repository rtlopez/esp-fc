...
namespace Espfc
{
  ...
  public:
    ...
    {
      if (voltage < 2.0)
        return false; // no battery connected
  ...
  struct GpsSatelite
  {
    ...
    union
    {
      ...
      struct
      {
        uint8_t qualityInd : 3;  // quality indicator: 0-no signal, 1-searching, 2-aquired, 3-unstable, 4-code locked, 5,6,7-code and carrier locked
